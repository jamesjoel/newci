...
class Home extends CI_Controller{
	...
	function auth()
	{
		...
		{
			// $_SESSION['msg']="This username and pa----";
			// $this->session->set_userdata("msg", "This Usernamd and Password");
			$this->session->set_flashdata("msg", "This Usernamd and Password Incorrect");
			redirect("home/login");
		}
	}
}
